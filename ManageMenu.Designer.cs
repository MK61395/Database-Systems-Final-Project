namespace DBProject
{
	partial class ManageMenu
	{
		...
		private void InitializeComponent()
		{
			...
			button5.Location = new Point(521, 391);
			button5.Name = "button5";
			button5.Size = new Size(159, 46);
			button5.TabIndex = 31;
			button5.Text = "Remove Item";
			...
			button2.Location = new Point(64, 391);
			...
			label5.Location = new Point(332, 67);
			label5.Name = "label5";
			...
			dataGridView1.Location = new Point(154, 93);
			dataGridView1.Name = "dataGridView1";
			dataGridView1.RowHeadersWidth = 51;
			dataGridView1.RowTemplate.Height = 29;
			dataGridView1.Size = new Size(412, 271);
			...
			label1.Location = new Point(298, 30);
			label1.Name = "label1";
