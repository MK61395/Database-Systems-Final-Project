namespace DBProject
{
	partial class ManageStaff
	{
		...
		private void InitializeComponent()
		{
			...
			button5.Location = new Point(540, 412);
			button5.Name = "button5";
			button5.Size = new Size(174, 46);
			button5.TabIndex = 4;
			button5.Text = "Remove Staff";
			...
			button3.Location = new Point(300, 412);
			...
			button2.Location = new Point(65, 412);
			button2.Name = "button2";
			button2.Size = new Size(174, 46);
			button2.TabIndex = 2;
			button2.Text = "Add Staff";
			...
			dataGridView1.Size = new Size(649, 267);
			...
			label1.Font = new Font("Calibri", 16.2F, FontStyle.Underline, GraphicsUnit.Point);
			...
			button4.Location = new Point(32, 425);
